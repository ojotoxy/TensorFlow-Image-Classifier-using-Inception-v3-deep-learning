...
# This list is used to further add suffix to your search term. Each element of the list will help you download 100
# images. First element is blank which denotes that no suffix is added to the search keyword of the above list. You
# can edit the list by adding/deleting elements from it.So if the first element of the search_keyword is 'Australia'
...
while i < len(search_keyword):
    ...
    while j < len(keywords):
        ...
        url = 'https://www.google.com/search?q=' + search + pure_keyword + '&espv=2&biw=1366&bih=667&site=webhp' \
                                                                           '&source=lnms&tbm=isch&sa=X&ei=XosDVaCXD8TasATItgE&ved=0CAcQ_AUoAg '
    ...
    total_time = t1 - t0  # Calculating the total time required to crawl, find and download all the links of 60,
    # 000 images
